...
function Header() {
  return (
    <div className="w-fill bg-HeaderBG h-[40px] flex">
      <div className="flex-[0.99] flex justify-center ml-5">
        <IconButton>
          <AccessTimeRoundedIcon style={{ color: "white", fontSize: "20px" }} />
        </IconButton>
        <div className="w-1/3 bg-seachBG mr-4 ml-4  mt-[7px] mb-[7px]  rounded-lg flex justify-center items-center">
          ...
          <input
            placeholder="🔍 Search slack theme"
      ...
      placeholder:text-xs text-white placeholder:text-center text-center"
        ...
        <IconButton>
          <HelpOutlineIcon style={{ color: "white", fontSize: "20px" }} />
        </IconButton>
      </div>
